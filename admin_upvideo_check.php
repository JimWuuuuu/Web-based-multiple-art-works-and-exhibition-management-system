...
<?php
	...
	$sql_work = "SELECT * FROM video where user_id = '$user_id' ORDER BY id DESC ";
	$sql2pic = mysqli_query($conn, $sql_work);
	$sql_work2 = "SELECT * FROM video where user_id = '$user_id' ORDER BY id DESC";
   ...
   ?>
	  ...
	  <video src="upvideo/<?php echo $r3pic['video_filename'];?>" controls></video>
		...
		<div class='card-body'>
		 ...
		 <a href='video_more_edit.php?id=<?php echo $r3pic['id']; ?>' class='btn btn-primary'>修改影片資訊</a>
		 <a href='admin_upvideo_delete_php.php?video_id=<?php echo $r3pic['id']; ?>' class='btn btn-primary'>刪除影片</a>
