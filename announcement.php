...
?>	
	...
	<!---------------------------分隔線-------------------------->	
	<form method="post" action="upannouncement.php" enctype="multipart/form-data">
	
	<!--公告標題-->
	<div class="input-group mb-3">
	  <div class="input-group-prepend">
		<img src="crayon.jpg" class="img-fluid img-thumbnail" alt="...">
		<font size="4">公告標題</font> <p></p>
		<input type="text" name="form_title" class="form-control" placeholder="輸入公告標題" aria-label="activityname" aria-describedby="basic-addon1">
	  </div>
	</div>
	...
	<div class="input-group mb-3">
		<div class="input-group-prepend">
		<img src="crayon.jpg" class="img-fluid img-thumbnail" alt="...">
		<font size="4">公告內容</font> <p></p>
		<input type="content" placeholder="輸入公告內容" name="form_content" size="100">
	...
	<div class="input-group mb-3">
		<div class="input-group-prepend">
		<img src="crayon.jpg" class="img-fluid img-thumbnail" alt="...">
		<font size="4">公告時間</font> <p></p>
		<font size="3">
		
		<?php 
		$today = date("Y-m-d");     // 2020-06-27 15:48（MySQL DATETIME 格式）
		echo $today;
		?>
		
		<p><p><p><p><br>
		
		<input type="submit" name="submit" value="發佈公告">
