...
<form action="piece_more_edit_php.php?picid=<?php echo $_GET['id']?>" method="post"  enctype="multipart/form-data">
	<div class="media">
  
		<div class="media-body">
			<h5 class="mt-0"><img src="brush.png" width="50"></img>
				<font size='6'>
					【作品名稱】：
						<?php if (isset($r3['piece_name'])) { ?>
							<input name="piece_name" type="text" value="<?php echo $r3['piece_name']; ?>">
						<?php }else{ ?>
							<input type="text" name="piece_name" placeholder="請輸入作品名稱！">
						<?php }?>
				</font>
			</h5>
			
			<p><img src="briefing.png" width="50"></img>
				<font size='6'>
					【簡介】：
						<?php if (isset($r3['description'])) { ?>
							<input name="piece_description" type="text" value="<?php echo $r3['description']; ?>">
						<?php }else{ ?>
							<input type="text" name="piece_description" placeholder="請輸入作品簡介！">
						<?php }?>
				</font>
			
			<p><img src="color-wheel.png" width="50"></img>
				<font size='6'>
					【類型】：
					<select name="piece_class" >
						<?php if (isset($r3['piece_class'])) { ?>
							<option value="<?php echo $r3['piece_class']; ?>"><?php echo $r3['piece_class']; ?></option>
							<option value="" disabled>請選擇要修改的作品類別</option>
