...
include_once('db_conn.php');
		$sql_a = "SELECT * FROM `announcement` ORDER BY `id` DESC";
...
<div class="row">
	...
	if ($sql && $sql->num_rows > 0) 
	{
		while ($r = $sql->fetch_assoc()) 
		{
			...
			$sql_b = "SELECT  * FROM `announcement` where id='$rid'";
	...
	?>
	<div class="jumbotron">
		<h1 class="display-4"><?php echo $r2['title']?></h1>
		<p class="lead">發佈者：<?php echo $r2['user_id'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;發佈日期：<?php echo $r2['time']?></p>
		<hr class="my-4">
		<p><?php echo $r2['content']?></p>
		<a class="btn btn-primary btn-lg" href="announcement_more.php?id=<?php echo $r2['id']; ?>" role="button">查看更多資訊</a>
		...
		<a class="btn btn-primary btn-lg" href="delete_new_php.php?id=<?php echo $r2['id']; ?>" role="button">刪除公告</a>
