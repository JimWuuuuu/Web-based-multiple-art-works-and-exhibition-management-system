...
<!---------------------------分隔線-------------------------->
	<?php
		if (isset($_GET['id'])) { 
			...
			$sql_c = "SELECT  * FROM announcement where id='$piece_id_more'";
	...
	<div class="jumbotron">
		<h1 class="display-4"><?php echo $r3['title']?></h1>
		<p class="lead">發佈者：<?php echo $r3['user_id']?></p>
		<hr class="my-4">
		<p><?php echo $r3['content']?></p>
	</div>
