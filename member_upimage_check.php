...
<!--                會員專區標題                        -->	
	...
	<p class="global-primary dark-primary section-title">
	  ...
	  管理員專區/審核作品，歡迎管理員，<?php echo $user; ?>
	  <br>
	  <br>
	  </span>
    </p>
...
<?php
	...
	$sql_work2 = "SELECT * FROM ccs_image ORDER BY id DESC";
   ...
   ?>
	  ...
	  <?php echo '<img src="data:image/png;base64,'.base64_encode($r3pic['bin_data']).'">';?>
		...
		<div class='card-body'>
		 ...
		 <a href='member_upimage_check_php.php?image_id=<?php echo $r3pic['id']; ?>' class='btn btn-primary'>審核通過</a>
		 <a href='member_upimage_delete_php.php?image_id=<?php echo $r3pic['id']; ?>' class='btn btn-primary'>刪除作品</a>
   ...
   ?>
	  ...
	  <?php echo '<img src="data:image/png;base64,'.base64_encode($r3pic2['bin_data']).'">';?>
		...
		<div class='card-body'>
		 ...
		 <a href='member_upimage_uncheck_php.php?image_id=<?php echo $r3pic2['id']; ?>' class='btn btn-primary'>取消審核</a>
