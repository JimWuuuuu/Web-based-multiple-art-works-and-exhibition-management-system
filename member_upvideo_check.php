...
<!--                會員專區標題                        -->	
	...
	<p class="global-primary dark-primary section-title">
	  ...
	  管理員專區/審核影片，歡迎管理員，<?php echo $user; ?>
	  <br>
	  <br>
	  </span>
    </p>
...
<?php
	...
	$sql_work = "SELECT * FROM video ORDER BY id DESC ";
	$sql2pic = mysqli_query($conn, $sql_work);
	$sql_work2 = "SELECT * FROM video ORDER BY id DESC";
...
<?php
  ...
  {
	  if($rrpic['upvideo_level']<=0){
    $ridpic=$rrpic['id'];
    //$sql = "SELECT * FROM users WHERE user_name='$uname' AND password='$pass'";
    $sql_pic = "SELECT  * FROM video where id='$ridpic'";
   ...
   ?>
	  ...
	  <video src="upvideo/<?php echo $r3pic['video_filename'];?>" controls></video>

		<div class='card-body'>
		 <h4 class='card-title'><span style="font-size:xx-large;"><?php echo $r3pic['video_name']?></span></h4>
		 <a href='member_upvideo_check_php.php?video_id=<?php echo $r3pic['id']; ?>' class='btn btn-primary'>審核通過</a>
		 <a href='member_upvideo_delete_php.php?video_id=<?php echo $r3pic['id']; ?>' class='btn btn-primary'>刪除影片</a>
...
<?php
  ...
  {
	  if($rrpic2['upvideo_level']>=1){
    $ridpic2=$rrpic2['id'];
    //$sql = "SELECT * FROM users WHERE user_name='$uname' AND password='$pass'";
    $sql_pic2 = "SELECT  * FROM video where id='$ridpic2'";
   ...
   ?>
	   ...
	   <div class='col-xs-6 col-sm-4'>
	  <div class='card text-center' style='width: 35rem;'>
	  <video src="upvideo/<?php echo $r3pic2['video_filename'];?>" controls></video>

		<div class='card-body'>
		 <h4 class='card-title'><span style="font-size:xx-large;"><?php echo $r3pic2['video_name']?></span></h4>
		 <a href='member_upvideo_uncheck_php.php?video_id=<?php echo $r3pic2['id']; ?>' class='btn btn-primary'>取消審核</a>
