...
<!--                會員專區標題                        -->	
	...
	<p class="global-primary dark-primary section-title">
	  ...
	  管理員專區/審核活動，歡迎管理員，<?php echo $user; ?>
	  <br>
	  <br>
	  </span>
    </p>
		...
		<?php echo '<img src="data:image/png;base64,'.base64_encode($r2['activity_pic']).'">';?>
			<!--<img src='image1.jpg' class='card-img-top' alt='圖片格式不對'>-->
				<div class='card-body'>
					...
					<a href='activity_check_php.php?activity_id=<?php echo $r2['id']; ?>' class='btn btn-primary'>審核通過</a>
					<a href='member_activity_delete_php.php?activity_id=<?php echo $r2['id']; ?>' class='btn btn-primary'>刪除活動</a>
				</div>			
		</div>
	</div>
	<?php
		...
		<?php echo '<img src="data:image/png;base64,'.base64_encode($r22['activity_pic']).'">';?>
			<!--<img src='image1.jpg' class='card-img-top' alt='圖片格式不對'>-->
				<div class='card-body'>
					...
					<a href='activity_uncheck_php.php?activity_id=<?php echo $r22['id']; ?>' class='btn btn-primary'>取消審核</a>
				</div>			
		</div>
	</div>
	<?php
