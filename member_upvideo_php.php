...
?>	
	...
	<!---------------------------分隔線-------------------------->	
	<form method="post" action="upvideo.php" enctype="multipart/form-data">
	
	<!--影片名稱-->
	<div class="input-group mb-3">
	  <div class="input-group-prepend">
		<img src="crayon.jpg" class="img-fluid img-thumbnail" alt="...">
		<font size="4">影片名稱</font>
		<font size="2" color="red">*</font> <p></p>
		<input type="text" name="form_video_name" class="form-control" placeholder="輸入影片名稱">
	  </div>
	</div>
	...
	<div class="input-group mb-3">
	  <div class="input-group-prepend">
		<img src="crayon.jpg" class="img-fluid img-thumbnail" alt="...">
		<font size="4">影片檔案</font>
		<font size="2" color="red">*</font> <p></p>
	  </div>
	</div>
    <input type="hidden" name="MAX_FILE_SIZE" value="51200000"> <br>
    <input type="file" accept="video/*" name="form_data" size="max"><br>
    <input type="submit" name="submit" value="上傳影片">
	</form>
